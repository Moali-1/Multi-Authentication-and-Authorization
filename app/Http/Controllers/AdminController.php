...
class AdminController extends Controller
{
    ...
    public function store(StoreAdminRequest $request)
    {
        ...
        return redirect()->route('back.admins.index')->with('success', __('messages.created'));
    }
    ...
    public function update(UpdateAdminRequest $request, Admin $admin)
    {
        ...
        return redirect()->route('back.admins.index')->with('success', __('messages.updated'));
    }
    ...
    public function destroy(Admin $admin)
    {
        $admin->syncRoles();
        $admin->delete();
        return redirect()->route('back.admins.index')->with('success', __('messages.deleted'));
    }
}
