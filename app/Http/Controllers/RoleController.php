...
class RoleController extends Controller
{
    ...
    public function store(RoleRequest $request)
    {
        ...
        return redirect()->route('back.roles.index')->with('success', __('messages.sent'));
    }
    ...
    public function update(RoleRequest $request, Role $role)
    {
        ...
        return redirect()->route('back.roles.index')->with('success', __('messages.updated'));
    }
    ...
    public function destroy(Role $role)
    {
        $role->syncPermissions();
        $role->delete();
        return redirect()->route('back.roles.index')->with('success', __('messages.deleted'));
    }
}